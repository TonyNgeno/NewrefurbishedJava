package com.tonyngeno.logic;


import com.tonyngeno.db.DbConnection;
import com.tonyngeno.db.DbConnectionI;
   ...
   DbConnectionI dbConnectionI;
    ...
    public boolean update(Student student)  throws SQLException{
        PreparedStatement preparedStatement = this
                .dbConnectionI
                .getConnection()
                .prepareStatement("UPDATE students SET name = ?, course = ?, idNumber = ? WHERE registrationNo = ?");
        preparedStatement.setString(1, student.getName());
        preparedStatement.setString(2, student.getCourse());
        preparedStatement.setString(3, student.getIdNumber());
        preparedStatement.setString(4,student.getRegistrationNo());
        return dbConnectionI.execute(preparedStatement);
    }
    ...
    public boolean delete(Student student)  throws SQLException{
        PreparedStatement preparedStatement = this
                .dbConnectionI
                .getConnection()
                .prepareStatement("DELETE FROM students WHERE registrationNo = ?");
